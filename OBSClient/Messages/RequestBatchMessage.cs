namespace OBSStudioClient.Messages
{
    ...
    public partial class RequestBatchMessage(bool haltOnFailure = false, RequestBatchExecutionType requestBatchExecutionType = RequestBatchExecutionType.SerialRealtime) : IMessage
    {
        /// <summary>
        ...
        public bool HaltOnFailure { get; } = haltOnFailure;

        /// <summary>
        /// The indication of how to process multiple requests in the batch.
        /// </summary>
        [JsonPropertyName("executionType")]
        public RequestBatchExecutionType RequestBatchExecutionType { get; } = requestBatchExecutionType;
