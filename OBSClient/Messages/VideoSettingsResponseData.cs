namespace OBSStudioClient.Messages
{
    ...
    public class VideoSettingsResponseData : IResponseData
    {
        ...
        public VideoSettingsResponseData(float fpsNumerator, float fpsDenominator, int baseWidth, int baseHeight, int outputWidth, int outputHeight)
        {
