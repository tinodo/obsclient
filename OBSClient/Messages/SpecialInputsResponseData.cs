namespace OBSStudioClient.Messages
{
    ...
    public class SpecialInputsResponseData : IResponseData
    {
        ...
        [JsonConstructor]
        public SpecialInputsResponseData(string desktop1, string desktop2, string mic1, string mic2, string mic3, string mic4)
        {
