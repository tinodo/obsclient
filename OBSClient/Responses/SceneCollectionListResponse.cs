namespace OBSStudioClient.Responses
{
    ...
    public class SceneCollectionListResponse(string currentSceneCollectionName, string[] sceneCollections) : IResponse
    {
        /// <summary>
        /// Gets the name of the current scene collection.
        /// </summary>
        [JsonPropertyName("currentSceneCollectionName")]
        public string CurrentSceneCollectionName { get; } = currentSceneCollectionName;
